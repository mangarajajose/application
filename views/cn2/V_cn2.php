        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="C_Dashboard">Home</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <!-- Close Card Body -->  
                  ...
                  <div class="card-footer">
                    ...
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button> 
										<?php if ($menu_name == 'Summary Kredit Note') { ?> 
                  <tr>
                    <td colspan="1">  </td>
                    <!-- <td colspan="10">  -->
            ...
            // Ajax isi data
              ...
              success: function (data) {
					   ...
					   $('#date_of_issue').val(data.date_of_issue);	
						...
						a.href = "<?php echo base_url('assets/upload/cn2/') ?>" + data.attachment_1;	
						}else{	
						...
						a.href = "<?php echo base_url('assets/upload/cn2/') ?>" + data.attachment_2;	
						}else{	
						a.removeAttribute("href");	
						};	
						...
						a.href = "<?php echo base_url('assets/upload/cn2/') ?>" + data.attachment_3;	
						}else{	
						a.removeAttribute("href");	
						};	
						...
						a.href = "<?php echo base_url('assets/upload/cn2/') ?>" + data.attachment_4;	
						}else{	
						a.removeAttribute("href");	
						};	
