<!DOCTYPE html>
                                            ...
                                            <small>
                                                ...
                                                <div class="container-fluid" id="printdiv">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <input id="text" type="text" hidden value="<?php $current = current_url() . '?var1=' . $tb_cn->hdrid;
                                                                        ...
                                                                        <!-- <center>
                                                                            ...
                                                                            <p id="qrcode"></p>
                                                                            <left><h4><strong>PT DENSO MANUFACTURING INDONESIA</strong></h4></left>
                                                                            <H5 align="right"><img src="denso_logo.png" style="width: 300px; height: 100px;"></H5>
                                                                            <hr style="border:1px solid black;">
                                                            
                                                                             
                                                                           <tr>
                                                                            <center><h5>CREDIT NOTE<h5></center>
                                                                            <center><h5>No :<?php echo substr($tb_cn->hdrid,2,10); ?></h5> </center>
                                                                           </tr>
                                                                           <h5 align="right">Cibitung,<?php echo $tb_cn->date_of_issue; ?></h5>

                                                                           <h5>To  &nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;<?php echo $tb_cn->company_to; ?><br></h5>
                                                                                    <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_cn->company_address; ?></h5>

                                                                                    <br>
                                                                                    <br>

                                                                            <h5>attn  : &nbsp;&nbsp;<?php echo $tb_cn->attention; ?><br></h5>
                                                                            <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_cn->attention_departement; ?></h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 style="text-align:center;">
                                                                ...
                                                                <h5>&nbsp;&nbsp;&nbsp;&nbsp;IDR&nbsp;&nbsp;<?php echo $tb_cn->amount; ?><h5>
                                                            </h5>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <h5 style="text-align:center;">
                                                        <h5>&nbsp;&nbsp;&nbsp;&nbsp;IDR&nbsp;&nbsp;<?php echo $tb_cn->amount_total; ?><h5>
                                                        </td>
                                                    </tr>
                                                   ...
                                                   <h5> PT DENSO MANUFACTURING INDONESIA<h5>
                                                    ...
                                                    <br>
                                                    <br>
                                                    <u><?php echo $tb_cn->director; ?><h5></u>
                                                    &nbsp;&nbsp;&nbsp;<?php echo $tb_cn->title; ?><h5>


                                                    <hr style="border:1px solid black;">
                                                    <center><h6><strong>KAWASAN INDUSTRI MM2100 BLOK FF-3,5,6 DANAU INDAH,CIKARANG BARAT,BEKASI,JAWA BARAT 17530-INDONESIA</strong></h6></center>
                                                    <center><h6><strong>PHONE:(62-21)898 1206 FAX:(62-21)898 1287</strong></h6></center>                       
                                ...
                                var bankset=( '<?php echo $tb_add_advance3->nama_bank ?>');
                                var recset=( '<?php echo $tb_add_advance3->transfer_date ?>');
                                // console.log(recset);
                                if (bankset=='' ) {
