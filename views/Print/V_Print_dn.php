                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <?php if ($this->session->userdata('user_name') == 'DM1901115')  {
                                                                            echo "Progress = Close";
                                                                        } else {
                                                                            echo "Progress = On progress";
                                                                        }?> 
                                                                    ...
                                                                    <input id="text" type="text" hidden value="<?php $current = current_url() . '?var1=' . $tb_dn2->hdrid;
                                                                        ...
                                                                        <center><h5>No:<?php echo substr($tb_dn2->hdrid,0,11); ?></b></h5></center>
                                                                           </tr>
                                                    ...
                                                    <tr>
                                                        <th colspan='12'scope="col">
                                                                ...
                                                                <br>
                                                                    ...
                                                                    <h5> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VAT<?php echo $tb_dn2->vat_persen;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->currency; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->vat_nominal; ?></h5>     
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_______________+
