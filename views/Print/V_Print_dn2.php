<!DOCTYPE html>
                                                ...
                                                <div class="container-fluid" id="printdiv">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="card">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <!-- ECR -->
                                                                    <input id="text" type="text" hidden value="<?php $current = current_url() . '?var1=' . $tb_dn2->hdrid;
                                                                                                                    print_r($current); ?>" />
                                                                        ...
                                                                        <center><h5>No:<?php echo substr($tb_dn2->hdrid,2,10); ?></b></h5></center>
                                                                           </tr>
                                                                           <h5 align="right">Cibitung,<?php echo $tb_dn2->date_of_issue; ?></h5>

                                                                           <h5>&nbsp;&nbsp;&nbsp;&nbsp;To  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo $tb_dn2->company_to; ?><br></b></h5>
                                                                                    <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->company_address; ?></h5>
                                                                                    <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->company_address1; ?></h5>
                                                                                    <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->company_address2; ?></h5>

                                                                                    <br>

                                                                                    <br>

                                                                            <h5>&nbsp;&nbsp;&nbsp;&nbsp;Attn &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;<b><?php echo $tb_dn2->attention; ?></b><br></h5>
                                                                            <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo $tb_dn2->attention_departement; ?></b></h5>
                                                                            <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo $tb_dn2->email_and_telp; ?></b></h5>
                                                    ...
                                                    <tr>
                                                        <th colspan='12'scope="col">
                                                                ...
                                                                <h5 style="text-align:center;" >
                                                                    ...
                                                                    <h5>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->detail_request; ?><h5>
                                                                        <h5>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->reference; ?><h5>
                                                                ...
                                                                <br>
                                                                 ...
                                                                 <?php } else { ?> 
                                                                    ...
                                                                    <h5> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DPP&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->currency; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->dpp; ?></h5>       
                                                                    <h5> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VAT<?php echo $tb_dn2->vat;?>&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->currency; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->vat_nominal; ?></h5>     
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;_______________+
                                                                    <h5> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOTAL&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->currency; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->amount_total; ?></h5>
                                                                
                                                                <?php }  ?>

                                                                 <br>
                                                                 <br>
                                                                 <?php if($tb_dn2->payment_terms=="partial") { ?>
                                                                     <!-- Kosong -->
                                                                 <?php } else { ?> 
                                                                ...
                                                                <h5>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->transfer_to; ?></h5>
                                                                <h5>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->transfer_address; ?></h5>

                                                                <h5>&nbsp;&nbsp;&nbsp;&nbsp;IDR:&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->idr; ?>
                                                                <h5>&nbsp;&nbsp;&nbsp;&nbsp;USD:&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->usd; ?>
                                                                <h5>&nbsp;&nbsp;&nbsp;&nbsp;EUR:&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->eur; ?>
                                                                <h5>&nbsp;&nbsp;&nbsp;&nbsp;JPY:&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->jpy; ?>
                                                                <h5>&nbsp;&nbsp;&nbsp;&nbsp;SWIFT CODE :<?php echo $tb_dn2->swift_code; ?>
                                                                <h5>&nbsp;&nbsp;&nbsp;&nbsp;A/C Name   :<?php echo $tb_dn2->account_name; ?>
                                                        ...
                                                        <th  colspan='13'>
                                                            <h5 style="text-align:center;">
                                                                ...
                                                                <h5>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->currency; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $tb_dn2->amount_total; ?><h5>
                                                            </h5>
                                                            
                                                        </th>
                                                        <?php }  ?>
                                                        <?php if($tb_dn2->payment_terms=="C30D") { ?>
                                                                     <!-- Kosong -->
                                                                 <?php } else { ?>        
                                                        <th rowspan='12'>
                                                                <h5 style="text-align:center;">
                                                    ...
                                                    <?php }  ?>
                                                           <br>
                                                                 ...
                                                                 <th><h5><php echo $tb_dn2->banyak_cicilan;?></h5> </th>
                                                                 <td>
                                                                <h5><php echo $tb_dn2->start_month;?></h5> 
                                                                </td>
                                                                <td>
                                                                <h5><php echo $tb_dn2->amount;?></h5> 
                                                                </td>
                                                                 </tr>
                                                                 <tr>
                                                                 <th><h5><php echo $tb_dn2->banyak_cicilan;?></h5>  </th>
                                                                ...
                                                                <h5><php echo $tb_dn2->amount;?></h5> 
                                                                 ...
                                                                 <th><h5><php echo $tb_dn2->banyak_cicilan;?></h5>  </th>
                                                                 <td>
                                                                <h5><php echo $tb_dn2-></php>start_month;?></h5> 
                                                                </td>
                                                                <td>
                                                                <h5><php echo $tb_dn2->amount;?></h5> 
                                                                </td>
                                                            ...
                                                            <tr>
                                                                 ...
                                                                 <tr>
                                                                        ...
                                                                        <th>
                                                                        <h5><?php echo $tb_dn2->amount_total;?></h5>
                                                   ...
                                                   <i>Amount in Word:<?php echo $tb_dn2->amount_in_word; ?><h5></i>
                                                   <?php }  ?>
                                                   ...
                                                   <?php if($tb_dn2->payment_terms=="partial") { ?>
                                                    ...
                                                    <?php } else { ?>  
                                                    <h5 style="text-align:left;">
                                                    <i> Payment Terms:<?php echo $tb_dn2->payment_terms; ?><h5></i>
                                                    <?php }  ?>
                                                  ...
                                                  <br>
                                                   <h5><b> PT DENSO MANUFACTURING INDONESIA</b><h5>
                                                    ...
                                                    <br>
                                                    <br>
                                                    <u><b><?php echo $tb_dn2->director; ?><h5></u>
                                                    &nbsp;<?php echo $tb_dn2->title; ?></b><h5>
                            ...
                            function Reject_data() {
                                ...
                                fdata2.append('nikreq', "<?php echo $tb_dn2->nik; ?>");
