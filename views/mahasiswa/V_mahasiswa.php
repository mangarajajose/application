              ...
              <form role="form" id="quickForm">
                ...
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="nama_panjang" class="form-control" id="nama_panjang" >
                      </div>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group" clearfix>
                  <div class="icheck-primary d-inline">
                      <input type="radio" id="jurusan" value="jurusan" name="jurusan"  >
                      <label for="jurusan">
                          JURUSAN
                      </label>
                  </div>
                  <div class="icheck-primary d-inline">
                      <input type="radio" id="jurusan2" value="jurusan2" name="jurusan" >
                      <label for="jurusan2">
                          JURUSAN2
                      </label>
                  </div>
                ...
                <div class="form-group" clearfix>
                  <div class="icheck-primary d-inline">
                      <input type="radio" id="fakultas" value="fakultas" name="fakultas"  >
                      <label for="fakultas">
                          FAKULTAS
                      </label>
                  </div>
                  <div class="icheck-primary d-inline">
                      <input type="radio" id="fakultas2" value="fakultas2" name="fakultas" >
                      <label for="fakultas2">
                          FAKULTAS2
                      </label>
                  </div>
                ...
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="input-group date" data-date-format="YYYY-MM-DD"  id="timepickertanggal_lahir" data-target-input="nearest">
                          <input type="text" id="tanggal_lahir" name="tanggal_lahir" class="form-control datetimepicker-input" data-target="#timepickertanggal_lahir"/>
                            <div class="input-group-append" data-target="#timepickertanggal_lahir" data-toggle="datetimepicker">
                              <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                            </div>
                        </div>
                      </div>
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-1">
                      <a class="btn btn-success" id="foto_kk_view" target="_blank"> <i class="fa fa-paperclip"></i> </a>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-7">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="foto_kk" multiple="" name="foto_kk">
                        <label class="custom-file-label" for="foto_kk" id="foto_kk_label">Choose file</label>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('c_mahasiswa/import'); ?>" enctype="multipart/form-data">
  ...
  $(document).ready(function () {
    ...
    $('#quickForm').validate({
      ...
      messages: {
        ...
        nama_panjang: {
        required: "Please Input nama_panjang",
        minlength: 3
        },
        nim: {
        required: "Please Input nim",
        minlength: 3
        },
        jurusan: {
        required: "Please Input jurusan",
        minlength: 3
        },
        fakultas: {
        required: "Please Input fakultas",
        minlength: 3
        },
        tanggal_lahir: {
        required: "Please Input tanggal_lahir",
        minlength: 3
        },
        foto_kk: {
        required: "Please Input foto_kk",
        minlength: 3
        },
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_mahasiswa/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
              success: function (data) {
                   ...
                   $('#nama_panjang').val(data.nama_panjang);
                    $('#nim').val(data.nim);
                    if(data.jurusan=='jurusan'){
                      document.getElementById('jurusan').checked=true;
                    }else
                    {
                      document.getElementById('jurusan2').checked=true;
                    }
                    if(data.fakultas=='fakultas'){
                      document.getElementById('fakultas').checked=true;
                    }else
                    {
                      document.getElementById('fakultas2').checked=true;
                    }
                    $('#tanggal_lahir').val(data.tanggal_lahir);
                    document.getElementById('foto_kk_label').innerHTML=data.foto_kk;
                    var a = document.getElementById('foto_kk_view');
                    if(!data.foto_kk==''){
                      a.href = "<?php echo base_url('assets/upload/') ?>" + data.foto_kk;
                    }else{
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_mahasiswa/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_mahasiswa/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_mahasiswa/ajax_delete')?>";
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_mahasiswa/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
...
<script type="text/javascript">
  ...
  function handleSelectChange_tb_mahasiswa_id(event) {

  var data = $('#tb_mahasiswa_id').select2('data')[0].text;

  if (data=='-Select-'){
    $('#tb_mahasiswa_name').val('');   
  }else{
    var res = data.split("-");
    $('#tb_mahasiswa_name').val(res[1]);
  };
