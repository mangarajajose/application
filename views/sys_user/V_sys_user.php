  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">sys_user Form</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <form role="form" id="quickForm">
                    ...
                    <div class="col-md-8">
                      <select class="form-control select2" id="nik" name="nik" onchange="handleSelectChange_nik(event)" style="width: 100%;">
                        ...
                        <?php
                          ...
                          echo "<option value='$value->nik'>$value->nik-$value->nik</option>";
                          }
                        ?>
                      </select>
                    </div>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <select class="form-control select2" id="role_id" name="role_id" onchange="handleSelectChange_role_id(event)" style="width: 100%;">
                        <option value='' selected="selected">-Select-</option>
                        <?php
                          foreach ($role_id as $value) {
                          echo "<option value='$value->role_id'>$value->role_id-$value->role_id</option>";
                          }
                        ?>
                      </select>
                    </div>
                ...
                <div class="form-group" clearfix>
                  <div class="icheck-primary d-inline">
                      <input type="radio" id="is_active" value="is_active" name="is_active"  >
                      <label for="is_active">
                          IS ACTIVE
                      </label>
                  </div>
                  <div class="icheck-primary d-inline">
                      <input type="radio" id="is_active2" value="is_active2" name="is_active" >
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('c_sys_user/import'); ?>" enctype="multipart/form-data">
  ...
  $(document).ready(function () {
    ...
    $('#quickForm').validate({
      ...
      messages: {
        ...
        user_name: {		
        required: "Please Input user_name",		
        minlength: 3		
        },		
        section_name: {		
        ...
        is_active: {		
        required: "Please Input is_active",		
        minlength: 3		
        },		
        role_name: {		
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_sys_user/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_sys_user/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_sys_user/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_sys_user/ajax_delete')?>";
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_sys_user/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
...
<script type="text/javascript">
  ...
  function handleSelectChange_tb_sys_user_id(event) {

  var data = $('#tb_sys_user_id').select2('data')[0].text;

  if (data=='-Select-'){
    $('#tb_sys_user_name').val('');   
  }else{
    var res = data.split("-");
    $('#tb_sys_user_name').val(res[1]);
  };
