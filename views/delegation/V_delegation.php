                    ...
                    <div class="col-md-8">
                      <select class="form-control select2" id="problem_id" name="problem_id"  style="width: 100%;">
                        ...
                        <?php
                          ...
                          echo "<option value='$value->hdrid'>$value->hdrid-$value->problem</option>";
                          }
                        ?>
                      </select>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <select class="form-control select2" id="position_code" name="position_code" onchange="handleSelectChange_position_code(event)" style="width: 100%;">
                        <option value='' selected="selected">-Select-</option>
                        <option value='1'>1-Inisiator</option>
                        <option value='2'>2-Inisiator Approver</option>
                        <option value='3'>3-Responsible</option>
                        <option value='4'>4-Responsible Approver 1</option>
                        <option value='5'>5-Responsible Approver 2</option>
                        <option value='6'>6-Inisiator after response check</option>
                        <option value='7'>7-Inisiator approver after response check</option>
                      </select>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="input-group date" data-date-format="YYYY-MM-DD HH:mm:ss"  id="timepickerdate_approve" data-target-input="nearest" >
                          <input type="text" id="date_approve" name="date_approve" class="form-control datetimepicker-input" data-target="#timepickerdate_approve" />
