    ...
    <section class="content-header">
      <div class="container-fluid"> <!-- container pada judul form-->
        <div class="row mb-2"> <!-- row pada halaman pada  ada judul form -->
          <div class="col-sm-6"> 
            <h1 class="m-0 text-dark">Transfer to Form</h1> <!-- judul form -->
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('C_transfer_to/import'); ?>" enctype="multipart/form-data">  <!--fungsi import dari controller-->   
