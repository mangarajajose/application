      ...
      <div class="container-fluid"><!-- container pada judul form-->
        <div class="row mb-2"><!-- row pada halaman pada  ada judul form -->
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="#">Home</a></li> <!--halaman home -->
              <li class="breadcrumb-item active">Dashboard v1</li> <!--halaman dashboard -->
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
  ...
  <!-- ##################################### Batas Modal #####################################  -->
     ...
     <div class="modal fade" id="modal-default" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">            
              ...
              <form role="form" id="quickForm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                      <input type="text" name="hdrid" class="form-control" id="hdrid" placeholder="auto generate" >
                    </div>
                </div>
              </div>
              <div class="form-group">
                    ...
                    <tbody>
                        ...
                        <div class="form-group">
                                  <div class="row">
                                      ...
                                      <div class="col-md-4">
                                        <div class="input-group date" data-date-format="YYYY-MM-DD"  id="timepickermonth_cil" data-target-input="nearest">
                                          <input type="text" id="month_cil" name="month_cil" class="form-control datetimepicker-input" data-target="#timepickermonth_cil"/>
                                            <div class="input-group-append" data-target="#timepickermonth_cil" data-toggle="datetimepicker">
                                              <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                            </div>
                                        </div>
                                      </div>
                                  ...
                                  <div class="row">
                                      <div class="col-md-4">
                                        <label for="amount_cil">amount_cil</label>
                                      </div>
                                      <div class="col-md-8">
                                        <input type="text" name="amount_cil" class="form-control" id="amount_cil" >
                                      </div>
                                  </div>
                                </div>
                                  <div class="form-group">
                                  <div class="row">
                                      <div class="col-md-4">
                                        <label for="nocil">nocil</label>
                                      </div>
                                      <div class="col-md-8">
                                        <input type="text" name="nocil" class="form-control" id="nocil" >
                                      </div>
                                  </div>
                                </div>
                        ...
                        <div>
                        <div class="btn btn-success"  id="btn_add_row"  onclick="add_tester()"> Tambah cicilan </div>
            ...
            <!-- </div> -->
              ...
              <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-8">
                      <input type="text" name="vat_nominal" class="form-control" id="vat_nominal" onchange="numberic_format(event);count_vat(event);"  >
                    </div>
                </div>
              </div>
              <!-- <div class="form-group">
              ...
              <php if ($this->session->userdata('user_name') == 'Widodo'){echo "un";} ?> -->
               <!-- <div class="form-group"    >
                <div class="row">
                    <div class="col-md-4">
        ...
        <div class="card card-blue" <?php if($menu_name!="Settlement Debit Note"){echo "hidden";} ?> >
                  <div class="card-header">
                    <h4 class="card-title">
        ...
        <!---------------------------------- / Form Macro Batas sini ---------------------------------->
                ...
                <div class="card-footer">
                  <!-- <button type="submit" class="btn btn-danger" id="btnsubmit" >Save</button>     -->
                    <button type="submit" class="btn btn-primary" id="btnsubmit" >SAVE</button>             <!--fungsi button save data di form-->           
  ...
  function view_modal(hdrid1,status){
    ...
    <?php } ?>
          if (status=="Add"){
            ...
            document.getElementById('title'). = false;
            }
          $('#btn_update_director').hide();
        ...
        $('#search').click(function(){
            ...
            else
            {
              ...
              <script type="text/javascript">
                    ...
                    /// @see  v
                  /// @note fungsi untuk 
                  /// @attention jika data sudah setting  maka data tidak bisa diinput
                  function v(form,vboolean){
                    ...
                    //   if(field.name=="hdrid"){
                    //     if(vboolean==true){
                    //       document.getElementsByName(field.name)[0].=true;
                    //     }else{
                    //       document.getElementsByName(field.name)[0].=false;
                    //     }
                    //   }
              ...
              function count_vat(event) {
                ...
                // document.getElementById('vat_nominal').value=vat_nom.toLocaleString(undefined, {maximumFractionDigits: 2});
                ...
                document.getElementById('amount_total').value=Math.floor(amount_total).toLocaleString(undefined, {minimumFractionDigits: 2});
