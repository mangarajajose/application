  ...
  document.getElementById('btnsubmit2').onclick = function() {
    ...
    alert(selected);
        ...
        $('#search').click(function(){
          ...
          /// @see  Update_director
          /// @note untuk membuat update pada director yang dimana akan dibuat rule readonly tapi dari finance bisa mengupdate director tersebut
          /// @attention
          ...
          fdata2.append('hdrid','<?php echo $this->session->userdata('rolename'); ?>');
          // Url Post delete
          ...
          function add_tester(){
            ...
            var name = document.getElementById("amount_cil");
            var surname = document.getElementById("month_cil");
            if ( document.getElementById("nocil").value == '') {
              var ss= 0;
              $('#nocil').val(ss);
            }else{
              var ss= Number(parseInt(document.getElementById("nocil").value))+1;
              $('#nocil').val(ss);
            }
            var output = document.getElementById("output2");
            output.innerHTML += "<tr><td>"+ ss +"</td><td>" + name.value + "</td><td>" + surname.value + "</td><td>'<div class='btn btn-danger btn-sm konfirmasiHapusTester' data-id="+ ss +"  > <i class='fa fa-trash'></i></div>'</td></tr>";
          }
