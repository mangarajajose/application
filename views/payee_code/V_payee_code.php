  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Payee Code Form</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="modal-content">            
              ...
              <form role="form" id="quickForm">
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-4">
                        <label for="payee_code">PAYEE CODE</label>
                      </div>
                      <div class="col-md-8">
                        <input type="text" name="payee_code" class="form-control" id="payee_code" >
                      </div>
                  </div>
                </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('c_payee_code/import'); ?>" enctype="multipart/form-data">
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_payee_code/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
              success: function (data) {
                   ...
                   $('#payee_code').val(data.payee_code);
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_payee_code/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_payee_code/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_payee_code/ajax_delete')?>";
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_payee_code/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
...
<script type="text/javascript">
  ...
  function handleSelectChange_tb_payee_code_id(event) {

  var data = $('#tb_payee_code_id').select2('data')[0].text;

  if (data=='-Select-'){
    $('#tb_payee_code_name').val('');   
  }else{
    var res = data.split("-");
    $('#tb_payee_code_name').val(res[1]);
  };
