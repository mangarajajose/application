              ...
              <!-- /form  -->
               ...
               <?php foreach ($hasil as $value) {  ?>
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-5">
                                    <!-- <label for="allow"> <?php echo $value->menu_name;  ?></label> -->
                                  <div class="icheck-primary d-inline">
                                    <div class="col-md-12">
                                        <label> <?php if(strlen($value->menu_id)>1){echo str_repeat('&nbsp;', 5);} ?> </label>
                          ...
                          <div class="col-md-1.5" <?php if(strlen($value->menu_id)==1){echo "hidden";} ?> >
                            <div class="icheck-primary d-inline">
                              <div class="col-md-12">
                                  <input type="checkbox" name="allow_add[]" id="allow_add" >
                                  <label for="allow_add">
