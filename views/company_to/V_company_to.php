        ...
        <div class="row mb-2"> <!-- row pada halaman pada  ada judul form -->
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="C_company_to">company to</a></li> <!--halaman dashboard -->
							<li class="breadcrumb-item active"><a href="C_currency">currency</a></li> <!--halaman dashboard -->
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="modal-dialog modal-lg" role="document" >
            <div class="modal-content">            
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col-md-4">
                      <label for="company_address2">COMPANY ADDRESS2</label>
                    </div>
                    <div class="col-md-8">
