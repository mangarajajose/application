            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <label for="attachment4">ATTACHMENT4 (FINANCE)</label>
                  </div>
                  <div class="col-md-7">
                    <div class="custom-file">
              ...
              <div class="form-group"   <?php if ($this->session->userdata('user_name') == 'Widodo'){echo "unreadonly";} ?> >
                <div class="row">
                    <div class="col-md-4">
                      <label for="director">DIRECTOR</label>
                    </div>
                    <div class="col-md-8">
                      <input type="text" name="director" class="form-control" id="director" unreadonly >
                    </div>
                </div>
              </div>
              <div class="form-group" <?php if ($this->session->userdata('user_name') == 'Widodo'){echo "unreadonly";} ?>>
                <div class="row">
                    ...
                    <div class="col-md-8">
                      <input type="text" name="title" class="form-control" id="title" unreadonly>
                    </div>
                </div>
              </div>
          </div>
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          if (status=="Add"){
            ...
            $('#director').val("<?php echo $director->director;?>"); //dept_id
        ...
        $('#search').click(function(){
            ...
            else
            {
              ...
              function count_vat(event) {
                ...
                words = toWords(ttl);
                $("#amount_in_word").val(words + "Rupiah");
