  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Bank Refund Form</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <form role="form" id="quickForm">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-8">
                    <input type="text" name="nama_account" class="form-control" id="nama_account" >
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <select class="form-control select2" id="nama_bank" name="nama_bank" onchange="handleSelectChange_nama_bank(event)" style="width: 100%;">
                        <option value='' selected="selected">-Select-</option>
                        <?php
                          foreach ($nama_account as $value) {
                          echo "<option value='$value->nama_account'>$value->nama_account</option>";
                          }
                        ?>
                      </select>
                    </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('c_bank_refund/import'); ?>" enctype="multipart/form-data">
  ...
  $(document).ready(function () {
    ...
    $('#quickForm').validate({
      ...
      messages: {
        ...
        nama_account: {
        required: "Please Input nama_account",
        minlength: 3
        },
        nama_bank: {
        required: "Please Input nama bank",
        minlength: 3
        },
        no_rekening: {
        required: "Please Input no_rekening",
        minlength: 3
        },
        currency: {
...
<script type="text/javascript">
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_bank_refund/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
              success: function (data) {
                  ...
                  $('#nama_account').val(data.nama_account);
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_bank_refund/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_bank_refund/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_bank_refund/ajax_delete')?>";
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_bank_refund/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
...
<script type="text/javascript">
  ...
  function handleSelectChange_tb_bank_refund_id(event) {

  var data = $('#tb_bank_refund_id').select2('data')[0].text;

  if (data=='-Select-'){
    $('#tb_bank_refund_name').val('');   
  }else{
    var res = data.split("-");
    $('#tb_bank_refund_name').val(res[1]);
  };
