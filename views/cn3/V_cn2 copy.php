  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Kredit Note</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
				...
				<?php if ($menu_name == 'Summary Debit Note') { ?> 
                  <tr>
                    ...
                    <!-- <td colspan="10">  -->
                      ...
                      <div class="bg-pink color-palette"> <span>Pink=Waiting Aprrove By Manager Finance</span></div> <!--untuk reminder kalau belum di approver finance-->
            ...
            <div class="modal-content">            
              ...
              <form role="form" id="quickForm">
				...
				<div class="icheck-primary d-inline">
					<input type="radio" id="payment_terms" value="payment_terms" name="payment_terms"  >
					<label for="payment_terms">
						PAYMENT TERMS
					</label>
				</div>
				<div class="icheck-primary d-inline">
					<input type="radio" id="payment_terms2" value="payment_terms2" name="payment_terms" >
				...
				<div class="row">
					<div class="col-md-4">
						<label for="detail_bank_account">DETAIL BANK ACCOUNT</label>
					</div>
					<div class="col-md-8">
						<input type="text" name="detail_bank_account" class="form-control" id="detail_bank_account" >
					</div>
				</div>
				</div>
				<div class="form-group">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form method="POST" action="<?php echo base_url('c_cn2/import'); ?>" enctype="multipart/form-data">
  ...
  $(document).ready(function () {
    ...
    $('#quickForm').validate({
      ...
      messages: {
				...
				detail_bank_account: {
				required: "Please Input detail_bank_account",
				minlength: 3
				},
				transfer_name: {
...
/// @attention tabel akan menampilkan siapa saja melakukan reject
  ...
  function view_modal(hdrid1,status){
          ...
          if (status=="Add"){
            ...
            // Ajax isi data
              $.ajax({
              url: "<?php echo base_url('C_cn2/ajax_getbyhdrid')?>",
              method: "get",
              dataType : "JSON",              
              data: {hdrid:hdrid1},
              success: function (data) {
					   ...
					   $('#date_of_issue').val(data.date_of_issue);
						...
						$('#detail_bank_account').val(data.detail_bank_account);
						...
						a.href = "<?php echo base_url('assets/upload/') ?>" + data.attachment_1;
						}else{
						...
						a.href = "<?php echo base_url('assets/upload/') ?>" + data.attachment_2;
						}else{
						a.removeAttribute("href");
						};
						...
						a.href = "<?php echo base_url('assets/upload/') ?>" + data.attachment_3;
						}else{
						a.removeAttribute("href");
						};
						...
						a.href = "<?php echo base_url('assets/upload/') ?>" + data.attachment_4;
						}else{
						a.removeAttribute("href");
						};
...
<script type="text/javascript">
   ...
   function Simpan_data($trigger){
          ...
          var vurl; 
          if($trigger == 'Add') {            
            vurl = "<?php echo base_url('C_cn2/ajax_add')?>";
          } else {           
            vurl = "<?php echo base_url('C_cn2/ajax_update')?>";
          }
  ...
  function Delete_data(){
      ...
      // Url Post delete
      vurl = "<?php echo base_url('C_cn2/ajax_delete')?>";
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "<?= base_url('C_cn2/view_data_where');?>", // URL file untuk proses select datanya
                "type": "POST",
                "data": function(data){     
...
<script type="text/javascript">
  ...
  function handleSelectChange_tb_cn2_id(event) {

  var data = $('#tb_cn2_id').select2('data')[0].text;

  if (data=='-Select-'){
    $('#tb_cn2_name').val('');   
  }else{
    var res = data.split("-");
    $('#tb_cn2_name').val(res[1]);
  };
