...
// vurl = "?php echo base_url('C_dn/ajax_reject') ?>";
...
$.ajax({
  ...
  error: function(e) {
    ...
    location.reload();
      ...
      vurl = "<?php echo base_url('C_dn/ajax_return') ?>";
...
$.ajax({
url: "<?php echo base_url('C_dn/ajax_updatepay') ?>",
method: "POST",
processData: false,
contentType: false,
data: fdata,
...
// Simpan or Update data
$.ajax({
url: "<?php echo base_url('C_dn/ajax_beneficiary') ?>",
method: "POST",
processData: false,
contentType: false,
data: fdata,
...
// Simpan or Update data
$.ajax({
url: "<?php echo base_url('C_dn/ajax_attach') ?>",
method: "POST",
processData: false,
contentType: false,
data: fdata,
