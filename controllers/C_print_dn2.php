...
class C_Print_dn2 extends CI_Controller
{
    /// @see __construct() 
    ...
    public function index()
    {
        ...
        $this->load->view('Print/V_Print_dn2', $data);
    }
    ...
    function ajax_getbyhdrid()
    {
        ...
        $data = $this->m_print->ajax_getbyhdrid($hdrid, 'tb_dn2')->row();
    ...
    function print_dn2()
    {
        ...
        $data['jumlah'] = 1;
        $data['tb_cicilan'] = $this->m_print->ajax_get_cicilan($hdrid, 'tb_cicilan_dn2');
        $data['tb_dn2'] = $this->m_print->ajax_getbyhdrid($hdrid, 'tb_dn2')->row();
