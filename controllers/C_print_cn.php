...
class C_Print_cn extends CI_Controller
{
    ...
    function ajax_getbyhdrid()
    {
        ...
        $data = $this->m_print->ajax_getbyhdrid($hdrid, 'tb_cn2')->row();
    ...
    function print_show()
    {
        ...
        $test = $data['tb_cn2'] = $this->m_print->ajax_getbyhdrid($hdrid, 'tb_cn2')->row();
        // error_reporting(0);
    ...
    function print_report1()
    {
        ...
        $data['username'] = $this->session->userdata('username');
        $data['tb_cn2'] = $this->m_print->ajax_getbyhdrid($hdrid, 'tb_cn2')->row();
