...
class C_cn extends CI_Controller {
	...
	public function Index()
	{
        ...
        $data['groups'] = $this->M_cn->get_tb_cn();
        ...
        $data['payee_code'] = $this->M_cn->Tampil_Payee_Code();// Menarik dan menampung ke data payee_code
        $data['finish_settlement_cn_bank'] = $this->M_cn->Tampil_Bank();// Menarik dan menampung ke data finish_settlement_cn_bank
        $data['tb_account_adv'] = $this->M_cn->tb_account_adv();// Menarik dan menampung ke data bank
    ...
    function view_data_where()
    {
        ...
        if ($menu_name=='Add advance') { // Kondisi jika menu_name = Add settlement
    ...
    /// @see ajax_cekdup()
    /// @note cek user reference duplicate atau tidak
    /// @attention
    ...
    function form_approver_link_mail(){
        ...
        $data['get_approver']=$this->M_cn->get_approver($id_user_reg); // Menarik data hasil query dan menampung nya sebagai data get_approver
		$data['get_requester']=$this->M_cn->get_requester($id_user_reg); // Menarik data hasil query dan menampung nya sebagai data get_requester  
		$data['data']=$this->M_cn->get_data($id_user_reg); // Menarik data hasil query dan menampung nya sebagai data 
        
        $this->load->view('email/V_cn',$data); // Tampil data
