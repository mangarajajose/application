...
class M_bank_refund extends CI_Model {
   ...
   public function Send_mail($hdrid)
   {
    ...
    $query =$this->db->query("
         ...
         ,date_approve
         ,description
     FROM bank_refund_approver
     where hdrid='WTR2010009' and level_approve=(select min(level_approve) from bank_refund_approver where hdrid='WTR2010009' and date_approve is null)");
   ...
   if ($query->num_rows()>0) {
      ...
      // Update progress waiting approve
       ...
       $this->db->where($where);
       $this->db->update('bank_refund_approver',$data);
   ...
   // Get Data Group bank_refund

    /// @see get_tb_bank_refund()
   /// @note
   /// @attention
   public function get_tb_bank_refund()
   {
    $query =  $this->db->get('tb_bank_refund')->result();
    return $query;
   }

   // Get Data report no By bank_refund ID
   ...
   /// @attention
    public function get_hdrid($table,$column,$value)
    {
        ...
        // return $this->db->get_where('tb_bank_refund', ['hdrid' => $bank_refund_id])->row_array();
    ...
    /// @see Tampil_NamaAccount()
   /// @note
   /// @attention
    public function Tampil_NamaAccount() 
    {
        $this->db->select('nama_account');
        $this->db->from('tb_nama_account');
