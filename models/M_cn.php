...
class M_cn extends CI_Model {
   ...
   /// @see get_tb_cn()
   /// @note   untuk mencari tb_cn
   /// @attention Select semua data dari table
   public function get_tb_cn()
   {
    $query =  $this->db->get('tb_cn')->result();
    return $query;
   }

   // Get Data report no By cn ID
   ...
   /// @attention
    ...
    /// @note untuk menampilkan company to pada credit note
    /// @attention Select semua data dari table
    ...
    /// @see Tampil_account()
    /// @note  untuk menampilkan account pada credit note
   ...
   public function Tampil_account()
   {
    ...
    /// @see Tampil_vat
     /// @note untuk menampilkan vat pada credit note
    /// @attention Select semua data dari table
    ...
    /// @note untuk menampilkan Currency pada credit note
    /// @attention Select semua data dari table
    ...
    /// @see Tampil_currency()
     /// @note untuk menampilkan director pada credit note 
    /// @attention Select semua data field dari table
    ...
    /// @note Select data hdrid terbesar
    /// @attention Untuk membuat hdrid di ajax_add
    public function Max_data_cn($hdridm,$table)
    {
   ...
   /// @note untuk menampilkan director pada debit note
    ...
    /// @note untuk menampilkan department pada credit note
    /// @attention Select semua data dari table
    ...
    /// @see Tampil_Bank()
   /// @note untuk menampilkan Bank pada credit note
   /// @attention Select semua data field dari table
    ...
    /// @see Tampil_Tipe_Transfer()
     /// @note untuk menampilkan account_adv pada credit note
    /// @attention Select semua data field dari table
...
//     }
    ...
    // }
            ...
            function Add_List_Approver($date_transaction,$hdrid,$nik)
            {
                ...
                /// @note Insert data approver ke tb_approval
                /// @attention
                function tb_approval_save_superior($date_transaction,$hdrid,$nik,$nominal)
                {
                    // Delete tb_approval dimana hdrid='$hdrid'
            ...
            // {   
            //     $this->db->query(" DELETE FROM tb_cicilan_cn where hdrid='$hdrid'");
            //     $amount = str_replace(',', '', $amount);
            //     $amount = (float) $amount;
            //     $hasil= number_format($amount/$cicilan, 2, ".", ",");
