...
class M_director extends CI_Model {
       ...
       /// @see get_tables()
   /// @note untuk mendapat data table pada director
   /// @attention data di tarik ke director
   function get_tables($tables,$cari,$iswhere)
        ...
        /// @note untuk mencari data table director
        /// @attention cari data di director
   ...
   public function Send_mail($hdrid)
   {
    ...
    $query =$this->db->query("
         ...
         ,date_approve
         ,description
     FROM director_approver
     where hdrid='WTR2010009' and level_approve=(select min(level_approve) from director_approver where hdrid='WTR2010009' and date_approve is null)");
   ...
   if ($query->num_rows()>0) {
      ...
      // Update progress waiting approve
       ...
       $this->db->where($where);
       $this->db->update('director_approver',$data);
   ...
   /// @attention data akan ditarik director
   public function get_tb_director()
   {
   ...
   /// @attention data bisa dicari search
    public function get_hdrid($table,$column,$value)
    {
        ...
        // return $this->db->get_where('tb_director', ['hdrid' => $director_id])->row_array();
