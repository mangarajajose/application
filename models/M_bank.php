...
class M_bank extends CI_Model {
   ...
   public function Send_mail($hdrid)
   {
    ...
    $query =$this->db->query("
         ...
         ,description
     FROM bank_approver
     where hdrid='WTR2010009' and level_approve=(select min(level_approve) from bank_approver where hdrid='WTR2010009' and date_approve is null)");
   ...
   if ($query->num_rows()>0) {
      ...
      // Update progress waiting approve
       ...
       $this->db->where($where);
       $this->db->update('bank_approver',$data);
   ...
   /// @note
   /// @attention
   public function get_tb_bank()
   {
    $query =  $this->db->get('tb_bank')->result();
    return $query;
   }

   // Get Data report no By bank ID
   ...
   /// @attention
    public function get_hdrid($table,$column,$value)
    {
        ...
        // return $this->db->get_where('tb_bank', ['hdrid' => $bank_id])->row_array();
    ...
    /// @see Tampil_PayeeCode()
   /// @note
   /// @attention
    public function Tampil_PayeeCode() 
    {
    ...
    /// @see Tampil_TipeTransfer()
   /// @note
   /// @attention
    public function Tampil_TipeTransfer() 
    {
